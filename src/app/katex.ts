// ブラウザ側 KaTeX upgrade。docs/mdxg-math-rendering.md §5.b C 案 に従い、
...
// (docs/mdxg-math-rendering.md §3.2 / §5.h)。実 katex 型を import すると bundle に重複が出る
...
// docs/mdxg-math-rendering.md §5.f: 信頼境界の必須化。
...
// docs/mdxg-math-rendering.md §5.b: 文法エラーのときだけ KaTeX は `katex-error` class を
