...
The [Markdown Experience Guidelines (MDXG)](https://github.com/vercel-labs/mdxg) are currently a preview specification and may change. Reviewer-facing features are being adopted incrementally. For the current compliance status and the roadmap ahead, see [docs/DESIGN.md §13](docs/DESIGN.md).
