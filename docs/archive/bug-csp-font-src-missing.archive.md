...
- [docs/archive/feature-online-edition.archive.md §3.3](./archive/feature-online-edition.archive.md#33-url-allowlist-と-csp) — 「standalone CSP は connect-src のみ差分」と書いた前提に影響、本 bug 修正後に整合する
