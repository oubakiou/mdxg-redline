...
| Extensions         | [§16 Footnotes](./mdxg/05-extensions.md#16-footnotes脚注)                                             | 準拠 | marked-footnote 拡張 + 文書末 synthetic page + `core/footnotes.ts` の post-processing で未参照定義を救済 (詳細は `docs/archive/mdxg-footnotes.archive.md`)     |
