...
```
node dist/review-request.mjs [--no-open] [--show-open-file] [--show-paste-markdown] [--document-name <name>] [--theme <system|light|dark>] [--shiki-langs <auto|all|none|<csv>>] [--mermaid <auto|on|off>] [--math <auto|on|off>] [--math-fonts <minimal|all>] [--comments-width <0|280-640>] [--page-nav-width <0|180-480>] [--markdown-css <path>] <input.md|-> [output-dir]
```
