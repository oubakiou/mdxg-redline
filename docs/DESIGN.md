...
- **`src/core/`** — 環境非依存の pure module。Node CLI / ブラウザ双方から import される（markdown / block-anchors / page-split / page-outline / slugify / search / embed / escape / feedback / review-export / scan-fenced-langs / scan-mermaid / math / shiki-aliases.generated / types）
