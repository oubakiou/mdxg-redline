...
| MDXG セクション                                                                                       | 必須レベル    | 現状                                                |
| ----------------------------------------------------------------------------------------------------- | ------------- | --------------------------------------------------- |
| [§1 Theming](./mdxg/01-rendering.md#1-themingテーマ)                                                  | MUST (Viewer) | 部分（DADS テーマ。host theme 追従は未実装）        |
| [§2 Code Block Rendering](./mdxg/01-rendering.md#2-code-block-renderingコードブロック描画)            | MUST (Viewer) | 部分（コピー button・シンタックスハイライト未実装） |
| [§3 Task Lists](./mdxg/01-rendering.md#3-task-listsタスクリスト)                                      | MUST (Viewer) | marked デフォルト                                   |
| [§4 Images](./mdxg/01-rendering.md#4-images画像) / [§5 Tables](./mdxg/01-rendering.md#5-tables表)     | MUST (Viewer) | marked デフォルト                                   |
| [§6 Virtual Pages](./mdxg/02-document-structure.md#6-virtual-pages仮想ページ)                         | MUST (Viewer) | 未対応（コメントモデルとの統合設計が必要）          |
| [§7 Page Navigation](./mdxg/02-document-structure.md#7-page-navigationページナビゲーション)           | MUST (Viewer) | 未対応                                              |
| [§8 Page Outline](./mdxg/02-document-structure.md#8-page-outlineページアウトライン)                   | MUST (Viewer) | 未対応                                              |
| [§9 Sequential Navigation](./mdxg/02-document-structure.md#9-sequential-navigation逐次ナビゲーション) | MUST (Viewer) | 未対応                                              |
| [§10 Search](./mdxg/02-document-structure.md#10-search検索)                                           | MUST (Viewer) | 未対応                                              |
| [§13 Keyboard Navigation](./mdxg/04-accessibility.md#13-keyboard-navigationキーボードナビゲーション)  | MUST (Viewer) | 部分                                                |
